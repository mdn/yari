...
- Within a template, the parameters passed in from the macro are available as
...
If the file isn't found, an empty string is returned. There is currently no way
