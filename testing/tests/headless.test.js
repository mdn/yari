...
describe("Basic viewing of functional pages", () => {
  ...
  it("open the /en-US/docs/Learn/CSS/CSS_layout/Introduction page", async () => {
    ...
    const flexSample1Uri = `${uri}/Flex/_samples_.Flex_1.html`;
    const flexSample2Uri = `${uri}/Flex/_samples_.Flex_2.html`;
    const gridSample1Uri = `${uri}/Grid/_samples_.Grid_1.html`;
    const gridSample2Uri = `${uri}/_samples_.Grid_2.html`;
  ...
  it("open the /en-US/docs/Learn/CSS/CSS_layout/Introduction/Flex page", async () => {
    ...
    const flexSample1Uri = `${uri}/_samples_.Flex_1.html`;
    const flexSample2Uri = `${uri}/_samples_.Flex_2.html`;
    await page.goto(testURL(uri));
  ...
  it("open the /en-US/docs/Learn/CSS/CSS_layout/Introduction/Grid page", async () => {
    ...
    const gridSample1Uri = `${uri}/_samples_.Grid_1.html`;
    const gridSample2Uri = `${uri}/_samples_.Grid_2.html`;
    await page.goto(testURL(uri));
