...
def test_not_cached(base_url, slug, status, expected_location):
...
def test_cached(base_url, slug, status, expected_location):
    """Ensure that these requests are cached."""
    assert_cached(base_url + slug, status, expected_location)
...
def test_zones_without_locale(base_url, zone, status, expected_location):
    """
