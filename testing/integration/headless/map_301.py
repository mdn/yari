...
SCL3_REDIRECT_URLS = list(
    flatten((
        ...
        url_test("{mdn,MDN}/{Contribute,contribute}",
...
LEGACY_URLS = list(
    flatten(
        (
            ...
            url_test("/web-tech/feed/atom/",
                     follow_redirects=True,
                     final_status_code=404),
            url_test("/css/wiki.css",
                     follow_redirects=True,
                     final_status_code=404),
            url_test("/css/base.css",
                     follow_redirects=True,
                     final_status_code=404),
            url_test("/contests",
...
REDIRECT_URLS = list(
    flatten((url_test("/en-US/fellowship",
...
MISC_REDIRECT_URLS = list(
    flatten((
        ...
        url_test("/en-US/profiles/sheppy/", "/en-US/settings",
                 status_code=302),
        url_test("/en-US/profiles/sheppy/edit",
                 "/en-US/settings",
                 status_code=302),
        url_test("/en-US/profiles/sheppy/edit/",
                 "/en-US/settings",
                 status_code=302),
        url_test("/en-US/profiles/sheppy/delete",
                 "/en-US/settings",
                 status_code=302),
        url_test("/en-US/profiles/sheppy/delete/",
                 "/en-US/settings",
        ...
        url_test("/en-US/DOM/CSSRule/cssText/",
                 "/en-US/docs/DOM/CSSRule/cssText"),
        ...
        url_test("/en-US/Web", "/en-US/docs/Web"),
        url_test("/en-US/Web/", "/en-US/docs/Web"),
        url_test("/en-US/Web/API/ArrayBuffer/",
                 "/en-US/docs/Web/API/ArrayBuffer"),
        url_test("/en-US/XMLHttpRequest", "/en-US/docs/XMLHttpRequest"),
        url_test("/en-US/XMLHttpRequest/", "/en-US/docs/XMLHttpRequest"),
        url_test("/en-US/XMLHttpRequest/FormData/",
        ...
        url_test("/eN-us/docs/Web/", "/en-US/docs/Web", status_code=302),
        url_test("/eN-us/docs/Web?next=FOO",
                 "/en-US/docs/Web",
                 status_code=302),
        url_test("/eN-us/docs/Web/?next=FOO",
                 "/en-US/docs/Web",
        ...
        url_test("/en-uS/search/", "/en-US/search", status_code=302),
        url_test("/en-Us/search?q=video",
                 "/en-US/search?q=video",
                 status_code=302),
        url_test("/en-Us/search/?q=video",
                 "/en-US/search?q=video",
                 status_code=302),
