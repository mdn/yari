...
MISC_REDIRECT_URLS = [
    ...
    url_test("/EN-us", "/en-US/"),
    url_test("/EN-us?next=FOO", "/en-US/?next=FOO"),
    url_test("/EN-US/", "/en-US/"),
    url_test("/EN-US/?next=FOO", "/en-US/?next=FOO"),
    url_test("/en-us/docs", "/en-US/docs"),
    url_test("/en-us/docs/", "/en-US/docs"),
    url_test("/eN-us/docs/Foo", "/en-US/docs/Foo"),
    url_test("/eN-us/docs/Foo/", "/en-US/docs/Foo"),
    url_test("/eN-us/docs/Foo?next=FOO", "/en-US/docs/Foo?next=FOO"),
    url_test("/eN-us/docs/Foo/?next=FOO", "/en-US/docs/Foo?next=FOO"),
    url_test("/en-uS/search", "/en-US/search"),
    url_test("/en-uS/search/", "/en-US/search"),
    url_test("/en-Us/search?q=video", "/en-US/search?q=video"),
    url_test("/en-Us/search/?q=video", "/en-US/search?q=video"),
]
