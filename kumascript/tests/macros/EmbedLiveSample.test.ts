...
describeMacro("EmbedLiveSample", function () {
  ...
  itMacro("One argument: ID", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' id="frame_quotations"' +
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/HTML/Element/figure/unsafe-runner.html?id=quotations">' +
        "</iframe></div>"
    );
  });
  itMacro("One argument: ID with HTML entities (bug?)", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/SVG/Element/switch/unsafe-runner.html?id=svg_ltswitchgt_example">' +
        "</iframe></div>"
    );
  });
  itMacro("One argument: percent-encoded ID", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/SVG/Element/switch/unsafe-runner.html?id=svg_switch_example">' +
        "</iframe></div>"
    );
  });
  itMacro("One argument: ID with percent-encoded page URL", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/fr/docs/Web/CSS/Utilisation_de_d%C3%A9grad%C3%A9s_CSS/unsafe-runner.html?id=d%C3%A9grad%C3%A9s_lin%C3%A9aires_simples">' +
        "</iframe></div>"
    );
  });
  itMacro("One argument: XSS attempt (failed)", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/HTML/Element/figure/unsafe-runner.html?id=scriptalertxssscript">' +
        "</iframe></div>"
    );
  });
  itMacro("Two arguments: ID, width", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' id="frame_example"' +
        ' width="100%"' +
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/CSS/border-top-width/unsafe-runner.html?id=example">' +
        "</iframe></div>"
    );
  });
  ...
  itMacro("Three arguments: ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/HTML/Element/figure/unsafe-runner.html?id=images">' +
        "</iframe></div>"
    );
  });
  itMacro("Three arguments: unicode ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' id="frame_增加关键帧"' +
        ' width="100%" height="250"' +
        ' src="https://mdn.mozillademos.org/zh-CN/docs/Web/CSS/CSS_Animations/Using_CSS_animations/unsafe-runner.html?id=%E5%A2%9E%E5%8A%A0%E5%85%B3%E9%94%AE%E5%B8%A7">' +
        "</iframe></div>"
    );
  });
  itMacro("Three arguments: url-encoded ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<div class="code-example"><p class="example-header"></p><iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/zh-CN/docs/Web/API/Canvas_API/Tutorial/Basic_usage/unsafe-runner.html?id=%E4%B8%80%E4%B8%AA%E6%A8%A1%E6%9D%BF%E9%AA%A8%E6%9E%B6">' +
        "</iframe></div>"
    );
  });
  ...
  const same_slug_iframe =
    ...
    ' src="https://mdn.mozillademos.org/en-US/docs/Web/CSS/flex-wrap/unsafe-runner.html?id=examples">' +
    "</iframe></div>";
