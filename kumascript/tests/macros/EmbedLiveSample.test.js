...
describeMacro("EmbedLiveSample", function () {
  ...
  itMacro("One argument: ID", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ' id="frame_Quotations"' +
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/HTML/Element/figure/_samples_.Quotations.html">' +
        "</iframe>"
    );
  });
  itMacro("One argument: ID with HTML entities (bug?)", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/SVG/Element/switch/_samples_.SVG_ltswitchgt_example.html">' +
        "</iframe>"
    );
  });
  itMacro("One argument: percent-encoded ID", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/SVG/Element/switch/_samples_.SVG_switch_example.html">' +
        "</iframe>"
    );
  });
  itMacro("One argument: ID with percent-encoded page URL", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/fr/docs/Web/CSS/Utilisation_de_d%C3%A9grad%C3%A9s_CSS/_samples_.D%C3%A9grad%C3%A9s_lin%C3%A9aires_simples.html">' +
        "</iframe>"
    );
  });
  itMacro("One argument: XSS attempt (failed)", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/HTML/Element/figure/_samples_.scriptalertXSSscript.html">' +
        "</iframe>"
    );
  });
  itMacro("Two arguments: ID, width", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ' id="frame_Example"' +
        ' width="100%"' +
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/CSS/border-top-width/_samples_.Example.html">' +
        "</iframe>"
    );
  });
  ...
  itMacro("Three arguments: ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/HTML/Element/figure/_samples_.Images.html">' +
        "</iframe>"
    );
  });
  itMacro("Three arguments: unicode ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ' id="frame_增加关键帧"' +
        ' width="100%" height="250"' +
        ' src="https://mdn.mozillademos.org/zh-CN/docs/Web/CSS/CSS_Animations/Using_CSS_animations/_samples_.%E5%A2%9E%E5%8A%A0%E5%85%B3%E9%94%AE%E5%B8%A7.html">' +
        "</iframe>"
    );
  });
  itMacro("Three arguments: url-encoded ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/zh-CN/docs/Web/API/Canvas_API/Tutorial/Basic_usage/_samples_.%E4%B8%80%E4%B8%AA%E6%A8%A1%E6%9D%BF%E9%AA%A8%E6%9E%B6.html">' +
        "</iframe>"
    );
  });
  ...
  itMacro('Four arguments: ID, width, height, ""', function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/CSS/::before/_samples_.Adding_quotation_marks.html">' +
        "</iframe>"
    );
  });
  itMacro("Four arguments: ID, width, height, screenshot", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<table class="sample-code-table"><thead><tr>' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/SVG/Tutorial/Gradients/_samples_.SVGLinearGradient.html">' +
  ...
  const same_slug_iframe =
    ...
    ' src="https://mdn.mozillademos.org/en-US/docs/Web/CSS/flex-wrap/_samples_.Examples.html">' +
    "</iframe>";
  ...
  itMacro('Five arguments: ID, "", "", "", other slug', function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/Events/blur/_samples_.Event_delegation.html">' +
        "</iframe>"
    );
  });
  itMacro(
  ...
  itMacro(
    ...
    function (macro) {
      ...
      return assert.eventually.equal(
        ...
        '<iframe class="sample-code-frame"' +
          ' id="frame_Event_delegation"' +
          ' src="https://mdn.mozillademos.org/en-US/docs/%22%3E%3Cscript%3Ealert(%22XSS%22);%3C/script%3E/_samples_.Event_delegation.html">' +
          "</iframe>"
      );
    }
  );
  itMacro('Six arguments: ID, width, height, "", "", class', function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="nobutton"' +
        ...
        ' src="https://mdn.mozillademos.org/en-US/docs/Web/CSS/-moz-appearance/_samples_.sampleNone.html">' +
        "</iframe>"
    );
  });
  itMacro(
    ...
    function (macro) {
      ...
      return assert.eventually.equal(
        ...
        '<iframe class="sample-code-frame"' +
          ...
          ' src="https://mdn.mozillademos.org/en-US/docs/Web/API/Media_Streams_API/Constraints/_samples_.Example_Constraint_exerciser.html"' +
