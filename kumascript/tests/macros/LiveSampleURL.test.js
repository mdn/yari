...
describeMacro("LiveSampleURL", function () {
  ...
  itMacro("Production settings", function (macro) {
    ...
    return assert.eventually.equal(
      macro.call("Example"),
      "https://mdn.mozillademos.org/en-US/docs/Web/HTML/Element/p/_samples_.Example.html"
    );
  });
  itMacro("Override page URL", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      "https://mdn.mozillademos.org/en-US/docs/HTML/Forms/How_to_build_custom_form_widgets/Example_2/_samples_.No_JS.html"
    );
  });
  ...
  itMacro("Staging settings", function (macro) {
    ...
    return assert.eventually.equal(
      macro.call("Examples"),
      "https://files-stage.mdn.mozit.cloud/en-US/docs/Web/CSS/background-color/_samples_.Examples.html"
    );
  });
  itMacro("Development default settings", function (macro) {
    ...
    return assert.eventually.equal(
      macro.call("Example"),
      "http://localhost:8000/en-US/docs/Web/HTML/Element/p/_samples_.Example.html"
    );
  });
  itMacro("Unicode ID", function (macro) {
    ...
    return assert.eventually.equal(
      macro.call("例子"),
      "https://mdn.mozillademos.org/zh-CN/docs/Web/CSS/flex-direction/_samples_.%E4%BE%8B%E5%AD%90.html"
    );
  });
  itMacro("Development demo settings", function (macro) {
    ...
    return assert.eventually.equal(
      macro.call("Example"),
      "http://demos:8000/en-US/docs/Web/HTML/Element/p/_samples_.Example.html"
    );
  });
});
