      ...
      <div id="recommendations" className="box">
        ...
        {["hsts-not-implemented-no-https", "hsts-invalid-cert"].includes(
          ...
          <div className="recommendation">
            ...
            <p>
              Adding HTTPS protects your site's visitors from tracking, malware,
              and injected advertising.
            </p>
            <p>
        ...
        {[
          ...
          <div className="recommendation">
            <p>
              ...
              never visit your site over HTTP accidentally?
            </p>
            <p>
        ...
        {[
          ...
          <div className="recommendation">
            ...
            <p>
              ...
              using the <code>Secure</code> flag to protect your cookies against
              their accidental transmission over HTTP. Furthermore, the use of{" "}
        ...
        {[
          ...
          <div className="recommendation">
            ...
            <p>
              ...
              stop automatically detecting the contents of files. This protects
              against attacks where they're tricked into incorrectly
        ...
        {["csp-implemented-with-unsafe-inline-in-style-src-only"].includes(
          ...
          <div className="recommendation">
            ...
            <p>
              ...
              Moving <code>style</code> attributes into external stylesheets not
              only makes you safer, but also makes your code easier to maintain.
            </p>
            <ul>
              <li>
        ...
        <div className="recommendation">
          ...
          <p>
            Make sure to check back occasionally to ensure that your website is
            keeping up with the latest in web security standards.
          </p>
          <p>
