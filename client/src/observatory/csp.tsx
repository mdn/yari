    ...
    <>
      ...
      <table className="fancy csp">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <InfoTooltip>
                ...
                Moving JavaScript to external files can also help make your site
                more maintainable.
              </InfoTooltip>
            </td>
          </tr>
          ...
          <tr>
            <td>
              Blocks inline styles by not allowing <code>'unsafe-inline'</code>{" "}
              inside <code>style-src</code>
            </td>
            <td>
              <Icon
                name={
            ...
            <td>
              <InfoTooltip>
                Blocking inline styles can help prevent attackers from modifying
                the contents or appearance of your page. Moving styles to
                external stylesheets can also help make your site more
                maintainable.
              </InfoTooltip>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <Icon
                name={
                  !policy.insecureSchemeActive ? "check-circle" : "alert-circle"
                }
              />
              <span className="visually-hidden">
            ...
            <td>
              <InfoTooltip>
                ...
                and changing links to HTTPS can help prevent this.
              </InfoTooltip>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <InfoTooltip>
                ...
                passive content such as images or videos over insecure protocols
                such as HTTP or FTP. Consider changing them to load them over
                HTTPS.
              </InfoTooltip>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <Icon
                name={policy.antiClickjacking ? "check-circle" : "alert-circle"}
              />
              <span className="visually-hidden">
          ...
          <tr>
            ...
            <td>
              <Icon
                name={!policy.insecureBaseUri ? "check-circle" : "alert-circle"}
              />
              <span className="visually-hidden">
