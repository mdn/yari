    ...
    <>
      <article className="deep-dive-article-container">
        ...
        <p className="article-lead">
          Viverra neque eget tellus, gravida pellentesque non. Purus, venenatis
          sit ac nam nec. At vitae facilisi in mi amet aliquam.
        </p>
        <Byline
        ...
        <p>
          ...
          set up to develop in a robust way, considering how your site will look
          in modern browsers, and how that look will differ in older browsers.
          In this article you can find out the tools that are available to help
          with this.
        </p>
        ...
        <p>
          ...
          Data (BCD) chart for the grid-template-columns property as an example.
        </p>
        <figure>
          <img
        ...
        <p>
          ...
          quick look at that property on MDN can quickly tell you if the problem
          is lack of support rather than anything you are doing wrong!
        </p>
        ...
        <p>
          ...
          described by the specification, or implementations in other browsers.
        </p>
        <ul>
          <li>
        ...
        <p>
          ...
          which time a large number of CSS features could have become available
          in your target browsers. It’s worth keeping an eye on features that
          are in beta versions of browsers, as they may be something you can use
        ...
        <p>
          ...
          doesn’t necessarily mean that it has shipped in the release version,
          but it may be in the beta already. Other places to look include the
          following resources:
        </p>
        <ul>
          <li>
        ...
        <p>
          ...
          your browser support strategy at the time of coding, but is likely to
          by launch.
        </p>
        ...
        <p>
          ...
          make sure that the code aimed at modern browsers doesn’t leak through
          to older browsers and make a mess.
        </p>
        <p>
          In recent years creating CSS fallbacks has become much easier and CSS
          has native features that can help you. Two of the most powerful are
          the cascade and feature queries, and we'll explore these now. Later on
          we'll also look at how vendor prefixes can be a useful tool as long as
          they are used carefully.
        </p>
        <h4>Using the cascade</h4>
        <p>
          The first thing to look at is how the cascade works with properties
          and values that are not understood by a browser. We can create simple
          fallbacks by writing CSS for old browsers, then following it with CSS
          aimed at newer browsers. For example, you might want to provide a
          simple solid background color for really old browsers, and a
        ...
        <div className="code-snippet">
          <code>
            ...
            <span className="code-m">0</span>,<span className="code-m">0</span>,
        ...
        <p>
          ...
          ignore it. Newer browsers will support both declarations, however the
          rules of the cascade mean that the declaration that comes later in the
          stylesheet will override the earlier one, and be used by the browser.
        </p>
        <p>
          ...
          becomes a grid item. We can see how this works in the following demo.
        </p>
        <p>
          In this example, the component has a simple, floated layout. This is
          the layout that browsers without CSS Grid support will use. For newer
          browsers the container has been turned into a grid container, which
          means that in a browser with CSS grid support the float is not
          applied.
        </p>
        <div className="code-snippet">
        ...
        <p>
          ...
          enhance the layout in newer browsers, if that CSS is also understood
          by older browsers.
        </p>
        <p>
          ...
          However, using the previous method the background color is understood
          and therefore used by browsers without CSS Grid support too. I have
          also added widths to the floated elements. As a percentage width is
          interpreted by the grid layout as a percentage of the column track,
          this causes the columns to become narrower than the track.
        </p>
        <div className="code-snippet">
          <div className="codepen">
            <iframe
        ...
        <p>
          ...
          values that are used with prefixed names, and this is indicated in the
          browser compat tables with a star, for example see the data for
        ...
        <p>
          ...
          browsers that only support a prefixed version of the property will use
          the version they understand, whereas browsers that support the
          standard version of the property will override the prefixed
          implementation and use that instead. This is most likely what you want
          &mdash; all browsers using the standard version wherever possible.
        </p>
        ...
        <p>
          ...
          for other tools built on top of the web platform by the community.
          Here we’ll look specifically at the PostCSS tool, and more generally
          at the concept of Polyfills.
        </p>
        <h4>PostCSS</h4>
        <p>
          ...
          looking specifically at features that help with browser compatibility,
          although it does include other tools that can help streamline your
          work.
        </p>
        <p>
        ...
        <p>
          ...
          features. To use it, you essentially need to write your CSS with IE10
          in mind &mdash; it’s not “set and forget” in the way that the rest of
        ...
        <p>
          ...
          and browser support is as you expected. If you are running into
          issues, you may have an extra place where a bug could have crept in.
          If something isn’t working as you expect, is it a browser bug or a bug
          in a tool you are using? This does create a potential extra element of
          risk, although these tools can be great timesavers when used
          carefully.
        </p>
        <h4>Polyfills</h4>
        <p>
          A polyfill is a piece of code that implements a feature in a browser
          that does not natively support it. This will usually be in the form of
        ...
        <p>
          ...
          assess their use as they have the potential to slow down the site and
          create a worse experience for the people you are trying to help.
        </p>
        <p>
          ...
          page has fully loaded before polyfills can get to work, which results
          in a second rendering of the page, and a CSS Grid polyfill would
          result in elements being shifted around by JavaScript. It would most
          likely be a far worse experience than serving users of that browser a
          simpler layout. Therefore with polyfills, just because you can,
        ...
        <p>
          ...
          issues are easy to deal with when looking at a single component but
          will seem overwhelming when you are faced with an entire application,
          or even a whole page that is displaying badly.
        </p>
        <p>
          ...
          able to install Chrome and Firefox. macOS users can also install
          Safari. Many other browsers &mdash; including Microsoft Edge &mdash;
          are now based on Chromium, the engine behind Chrome. However, bear in
          mind that you should still test in them &mdash; not all of these
          browsers are running the same version of Chromium as the release
          version of Chrome.
        </p>
        <p>
        ...
        <div className="article-sidebar">
          <p>
            ...
            iOS device, these browsers all use WebKit, the engine behind Safari,
            to render web pages. In addition, it can be worth getting an
            inexpensive Android device, especially if you are an iPhone user. By
            purchasing a low-end Android device, you can not only ensure that
            you are testing in Mobile Chrome, but also check out the experience
            of your site on a device that is less powerful than your usual
            phone.
          </p>
        </div>
        <p>
          In a larger company you may well be able to set up a testing lab with
          a few different versions of browsers, and some mobile devices for
          testing. Even as a lone developer, if you are a Windows user it may be
          worth picking up an inexpensive second-hand Apple laptop, just check
          that your site can run on macOS browsers.
        </p>
        <p>
