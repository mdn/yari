  ...
  return (
    <>
      <article className="deep-dive-article-container">
        ...
        <p>
          With regard to CSS, the issues we will be discussing are very similar
          on desktop and on mobile; by writing your CSS in a resilient way you
          can ensure that everyone can get a great experience on your site.
        </p>
        ...
        <p>
          ...
          2013, that’s only 11 versions of IE in almost 20 years! Due to this,
          the most current version of a browser could be quite out of date in
          terms of feature support. In addition new versions often contained
          breaking changes and so individuals and IT departments would not
          update their browsers due to fears of sites and systems that they
          relied upon breaking.
        </p>
        <p>
          ...
          browser without risk of breaking things. As an example, a new version
          of Firefox is usually released every 4 weeks as of the time of
          writing.
        </p>
        <p>
          For most of us, the last browser based on the old release model that
          we might need to continue supporting is Internet Explorer 11. IE11 is
          still used by enough people to worry about (depending on your target
        ...
        <p>
          Later on in this guide you will find out how to write CSS that creates
          a fallback for Internet Explorer, which it can use when presented with
        ...
        <p>
          ...
          to the spec for any feature at the bottom of its MDN page. These specs
          detail how browsers should implement a feature, the goal being that
          each browser will implement the feature in exactly the same way.
          Modern CSS specs are very detailed, and written with input from
          engineers who work on all of the major browsers, which is one reason
          why we have far fewer bugs in modern browsers than we saw in the past.
        </p>
        <p>
          However, sometimes differences appear between browser implementations.
          Perhaps the spec wasn’t quite detailed enough, or a problem doesn’t
          show up until the new CSS property interacts with some other part of
          CSS, or a mistake is made when implementing the feature. Bugs happen
          in software development, and browsers are no different.
        </p>
        <p>
          ...
          create a reduced test case to isolate the problem, decide on a
          strategy for working round it, and report the issue to a browser
        ...
        <p>
          ...
          features as an enhancement, while giving the non-supporting browsers a
          perfectly solid experience. The good news is that CSS has evolved to
          make this much easier for you, and later on you will learn how to use
          CSS to create sites that evolve as browsers do, giving yourself the
          ability to use these new features before there is widespread support.
        </p>
        ...
        <p>
          ...
          they may interpret that as meaning you are going to make it impossible
          for Internet Explorer users to visit the site. Their idea of support
          is probably more binary &mdash; you get the full experience or
          nothing!
        </p>
        <p>
        ...
        <div className="article-sidebar">
          ...
          <ul>
            ...
            <li>
              C-grade browsers were known to be older or less capable. A subset
              of these browsers were tested to make sure they were not getting a
          ...
          <p>
            ...
            that was far slower moving than today, however web developers at the
            time found this approach helpful. Our modern support strategies can
            be seen as an evolution of this idea.
          </p>
        </div>
        ...
        <p>
          ...
          from the beginning of your project will make the process far easier.
          No one wants to be in the situation of sending a completed site to a
          client and having them on the phone 10 minutes later complaining about
          a mess in their favorite browser!
        </p>
        <p>
          By creating a strategy, and making decisions up front, you can test
          against key browsers as you work. If a problem comes up that requires
          a feature not supported by some target browser, you have a good basis
          for discussing it and deciding if an exception can be made or a
          polyfill found.
        </p>
        <p>
        ...
        <p>
          ...
          good experience. You will however provide a simplified layout, and not
          attempt to completely recreate the same design that the modern
        ...
        <p>
          ...
          have a good amount of information about the browsers and devices
          people are using to access your site from your analytics. You should
          be able to find out how many users are using old versions of Internet
          Explorer, how many are on mobile devices, and which versions of
          evergreen browsers that are in use.
        </p>
        <p>
        ...
        <div className="notecard note">
          <p>
            ...
            people can use to refresh their memories quickly, and grab and adapt
            for their own support chart.
          </p>
          <p>
        ...
        <p>
          ...
          whistles in CSS, basing your design on new features such as flexbox
          and grid is likely to make development faster. CSS based on modern
          layout techniques rather than carefully calculated floats will be less
          fragile. This will make future feature additions easier too.
        </p>
        <p>
          If you decide that it is important for Internet Explorer users to see
          the exact same layout as those using up-to-date Firefox or Chrome,
        ...
        <p>
          ...
          accessibility, or improving performance, is likely to benefit far more
          people.
        </p>
        <p>
          ...
          recreate a complex design using those methods, can actively slow down
          your site. Slow sites are penalized by search engines, and by users
          who don’t want to wait for heavy pages to load. Are you willing to
          lose those users in order to provide the full design to users of older
          browsers?
        </p>
        <div className="article-sidebar">
          <p>
        ...
        <p>
          ...
          little enhancements that add some delight but wouldn’t be missed if
          they didn’t appear.
        </p>
        <p>
          For example, the{" "}
          ...
          property is not currently supported in Firefox. It might be ideal for
          an image and text treatment that you have in mind. Would your policy
          allow for using this with a fallback to a solid color in Firefox?
        </p>
        <p>
          Or, consider the subgrid feature of CSS Grid Layout, which is
          currently only available in Firefox. You might decide that relying on
          this feature is not appropriate, but be happy to use it to get better
          alignment across some components, knowing that as it ships in Chrome
          and other browsers they will get the better experience too.
        </p>
        <div className="article-sidebar">
          <p>
            Later in this guide you will learn how to implement enhancements
            such as these in a way that doesn’t rely on browser detection. This
            means that if you decide to go with a fallback for non-supporting
            browsers, as soon as the browser implements the feature, users will
            get the full effect.
          </p>
        </div>
        ...
        <p>
          ...
          reality of seeing the much plainer site in IE11 will come as a shock
          to someone.
        </p>
        <p>
          ...
          that you will take the same care with those key things in the simpler
          layout as you do with the modern layout will help calm any concerns.
        </p>
        <h3>Keep your strategy up-to-date</h3>
        <p>
          Unless your site is a one-off, handed over to a client and never seen
          again, it is likely that you will be adding new features to the site
          in future. When planning these new features, remember to refer back to
          and consider updating your strategy in the light of browser and
          audience changes. Old Internet Explorer browsers will go away, new
          features will be developed, and you don’t want to be dragging the
          support requirements of the past along with you for the entire
