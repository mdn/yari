...
const MDNLogo = (props) => (
  <svg
    ...
    style={{
      enableBackground: "new 0 0 361 104.2",
    }}
    xmlSpace="preserve"
    role="img"
    {...props}
  >
    ...
    >
      <path d="M42 .2 13.4 92.3H1.7L30.2.2H42zM52.4.2v92.1H42V.2h10.4zm40.3 0L64.2 92.3H52.5L81 .2h11.7zM103.1.2v92.1H92.7V.2h10.4zM294 95h67v8.8h-67V95z" />
    </g>
  </svg>
);

export default MDNLogo;
