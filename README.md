...
When you ran `npm i` for the first time (`npm i` is an alias for `npm install`)
...
For more details on this command, see the
[`npm-upgrade`](https://www.npmjs.com/package/npm-upgrade) packages.
