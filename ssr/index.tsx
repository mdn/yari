 ...
 * Using it will ignore all css and scss imports, which is required to be able
 * to import the client workspace.
 */
import "./IGNORE_STYLE_IMPORTS";
...
function buildHtmlAndJsonFromDoc({ doc, destinationDir, buildHtml, titles }) {
  const options = { doc };
