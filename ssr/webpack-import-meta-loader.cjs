/**
 * Copied from https://www.npmjs.com/package/@open-wc/webpack-import-meta-loader
 * and made to work for Node in Webpack 4.
 */
    ...
    return `
      function getAbsoluteUrl(relativeUrl) {
        ...
        if (typeof window === "undefined") {
          url += 'file:///example';
        } else if (!publicPath || publicPath.indexOf('://') < 0) {
