...
<html lang="en">
  ...
  <body>
    <main>
      ...
      <h1>Caution: This is a Custom Preview from an <a href="https://developer.mozilla.org/en-US/play">MDN Playground</a></h1>
      <p>You’re about to view a live preview generated by the MDN Playground. This preview may include custom code created by another user and is intended for testing and exploration only. If you’re uncertain about its contents or would prefer not to proceed, you can open the example in the MDN Playground. Otherwise, feel free to continue and explore the example provided.</p>
      <details>
